...
app.post("/signup-intermediate",function(req,res){
	console.log(req);
	...
	Restaurant.findOne({email:req.body.email},function(err,user){
		...
		if(!user){
			...
			let hash = otpTool.createNewOTP(Email,otp);
			res.render("otp",{
				email:req.body.email,
				password:req.body.password,
				name:req.body.name,
...
paytmParams.body = {
    ...
    "txnType"      : "REFUND",
    "orderId"      : "60c61dfb54f55642741e061c55231623596625533",
    "txnId"        : "20210613111212800110168317802726822",
    "refId"        : "REFUNDID_98760",
    "refundAmount" : "1.00",
};
...
*/
PaytmChecksum.generateSignature(JSON.stringify(paytmParams.body), "war1bWLyTR6%s4Ae").then(await function(checksum){
    ...
    var post_req = https.request(options, function(post_res) {
        ...
        post_res.on('end', function(){
            ...
            res.render("refund-intermediate",{
...
app.post("/refund-intermediate",function(req,res){
	console.log("In refund-intermediate");
	var paytmParams = {};
...
* Find your Merchant Key in your Paytm Dashboard at https://dashboard.paytm.com/next/apikeys 
*/
PaytmChecksum.generateSignature(JSON.stringify(paytmParams.body), "war1bWLyTR6%s4Ae").then(function(checksum){
